...
export function MapStyleSelect({
  ...
  return (
    <select
      ...
      className="rounded-xl border border-white/80 bg-white/92 px-3 py-2 text-sm font-medium text-[color:var(--color-text)] shadow-[0_12px_24px_rgba(15,23,42,0.14)] outline-none backdrop-blur-sm"
