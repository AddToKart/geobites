...
import { PaymentLayout, MAYA_BRAND } from "@/features/customer/payment/PaymentLayout";
import { PaymentSuccess } from "@/features/customer/payment/PaymentSuccess";
import api from "@/services/api";
import { toast } from "sonner";

export function PaymentMayaPage() {
  ...
  return (
    <PaymentLayout brand={MAYA_BRAND} merchantName="Geobites" amount={amount}>
      {step === "phone" && (
        <div className="space-y-12">
          <div>
            ...
            <h2 className="text-4xl font-medium tracking-tighter mb-4">Log in to Maya</h2>
          ...
          <form onSubmit={handlePhoneSubmit} className="space-y-8">
            <div className="space-y-4">
              ...
              <div className="relative">
                ...
                <Input
                  ...
                  className="pl-16 h-20 rounded-none text-3xl font-medium border-border bg-transparent shadow-none focus-visible:ring-0 focus-visible:border-[#00D15A] transition-colors"
                  maxLength={10}
                  required
                />
              </div>
            ...
            <button
              type="submit"
              className="w-full h-16 bg-[#00D15A] text-white hover:bg-[#00a849] font-bold uppercase tracking-widest text-sm flex items-center justify-center gap-3 transition-colors"
            >
              Next
          ...
          <form onSubmit={handleOtpSubmit} className="space-y-8">
            <div className="space-y-4">
              ...
              <Input
                ...
                className="h-20 rounded-none text-4xl font-medium text-center tracking-[0.2em] border-border bg-transparent shadow-none focus-visible:ring-0 focus-visible:border-[#00D15A] transition-colors"
                maxLength={6}
                required
              />
            </div>
      ...
      {step === "confirm" && (
        <div className="space-y-12 animate-in slide-in-from-right-8 duration-300">
          ...
          <div className="border border-border bg-secondary/5 p-8 space-y-6">
            <div className="flex justify-between items-start border-b border-border pb-6">
              ...
              <div className="text-right">
                <span className="block text-xl font-medium tracking-tighter text-[#00D15A]">Maya Wallet</span>
          ...
          <button
            ...
            className="w-full h-16 bg-[#00D15A] text-white hover:bg-[#00a849] font-bold uppercase tracking-widest text-sm flex items-center justify-center gap-3 transition-colors disabled:opacity-50"
          >
      ...
      {step === "success" && <PaymentSuccess brandBg="bg-[#00D15A]" />}
    </PaymentLayout>
  );
}
